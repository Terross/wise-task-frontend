            ...
            <v-container>
                <v-row>
                    <v-text-field 
                        ...
                        variant="outlined"
                        v-model="taskNameModel"></v-text-field>
                    <v-text-field 
                        class="ma-2"
                        label="Категория задачи"
                        variant="outlined"
                        v-model="taskCategoryModel"></v-text-field>
                </v-row>
            </v-container>
            <v-container>
                <v-row>
                    <v-switch label="Граф задан" v-model="graphPresentModel"></v-switch>
                    <v-switch label="Показывать ошибку только в первом модуле" v-model="isHiddenMistake"></v-switch>
                </v-row>
            </v-container>
            <v-container>
...
export default defineComponent({
    ...
    methods: {
        createTask() {
            ...
            const graph = (Object.keys(this.activeGraph.nodes).length > 0)
