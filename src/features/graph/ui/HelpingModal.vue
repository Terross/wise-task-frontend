      ...
      <v-card-text>
        ...
        <ul>
          <li>
            ...
            на область графа. Новая вершина будет создана в указанном месте.
          </li>
          <li>
        ...
        <ul>
          <li>Выберите вершину, кликнув по ней левой кнопкой мыши.</li>
          <li>
            Над вершиной появится меню. Для удаления нажмите на значок крестика
